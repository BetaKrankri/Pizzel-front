...
export const TestAPI = () => {
  ...
  return (
    <div className="ring ring-emerald-500 flex flex-col items-center ">
      TestAPI
      <div className=" bg-fuchsia-400 max-w-lg overflow-hidden break-words">
        <p>{authCtx?.loggedUser?.displayName}</p>
        <p>{authCtx?.loggedUser?.email}</p>
        {authCtx?.loggedUser?.token}
      </div>
      {/* Start Portfolio Panel */}
      <div className="Wrapper flex ">
        <div className="API/Portfolio bg-slate-400 p-3 flex flex-col gap-2">
          {/*  GET ALL PORTFOLIOS */}
          <button
            className="p-3 bg-sky-900"
            onClick={async () => {
          ...
          >
            ...
            />
            <button className="p-3 bg-sky-900">createPortfolio</button>
          </form>
          {/* UPDATE PORTFOLIO */}
          <form
            className="ring ring-slate-500 flex flex-col gap-2"
          ...
          >
            ...
            />
            <button className="p-3 bg-sky-900">updatePortfolio</button>
          </form>
          {/* DELETE PORTFOLIO */}
          <form
            className="ring ring-slate-500 flex flex-col gap-2"
          ...
          >
            ...
            />
            <button className="p-3 bg-sky-900">deletePortfolio</button>
          </form>
          ...
          >
            ...
            />
            <button className="p-3 bg-sky-900">getPortfolio</button>
          </form>
        </div>

        {/* Start Canvas Panel */}
        <div className="API/Canvas bg-stone-400 p-3 flex flex-col gap-2">
          {/* GET ALL CANVASES */}
          <button
            className="p-3 bg-amber-900"
            onClick={async () => {
          ...
          >
            ...
            />
            <button className="p-3 bg-amber-900">createCanvas</button>
          </form>
          {/* DELETE CANVAS */}
          <form
            className="ring ring-amber-500 flex flex-col gap-2"
          ...
          >
            ...
            />
            <button className="p-3 bg-amber-900">deleteCanvas</button>
          </form>
          {/* GET CANVAS  */}
          <form
            className="ring ring-amber-500 flex flex-col gap-2"
          ...
          >
            ...
            />
            <button className="p-3 bg-amber-900">getCanvas</button>
          </form>
          {/* UPDATE CANVA 9*/}
          <form
            className="ring ring-amber-500 flex flex-col gap-2"
          ...
          >
            ...
            <button className="p-3 bg-amber-900">updateCanvas</button>
          </form>
        </div>
      </div>
      {/* Start Canvas Panel */}
      <div className="API/Account min-w-[400px] bg-pink-400 p-3 flex gap-3">
        {/* Create User */}
        <form
        ...
        >
          ...
          />
          <button className="p-3 bg-rose-900">createUser</button>
        </form>
        {/* Log in  User */}
        <form
          className="ring ring-red-600 flex flex-col"
        ...
        >
          ...
          />
          <button className="p-3 bg-rose-900">login user</button>
        </form>
      </div>
    </div>
  );
